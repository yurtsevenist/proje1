...
<!-- How to change your own map point
  ...
  4. Copy only URL and paste it within the src="{{asset('fronttema')}}/" field below
-->
          <div id="map">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="contact-form">
            <form id="contact" action="{{route('mesajKaydet')}}" method="post">
              @csrf
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <fieldset>
                    <input name="email" type="text" class="form-control" id="email" placeholder="E-Posta Adresiniz" required="">
                  </fieldset>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <fieldset>
